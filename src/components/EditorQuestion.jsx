...
//           ))}
//           <label className="AdminQuestion_test_label">گزینه صحیح:</label>
//           <select className="AdminQuestion_test_select" value={correctOption} onChange={(e) => setCorrectOption(e.target.value)}>
//             <option className="AdminQuestion_test_option" value="">انتخاب کنید</option>
//             {options.map((_, index) => (
//               <option className="AdminQuestion_test_option" key={index} value={index}>
//                 گزینه {index + 1}
//               </option>
//             ))}
//           </select>
...
//       <div className="AdminQuestion_button_div">
//                 <button className="AdminQuestion_button" onClick={handleAddQuestion}>اضافه کردن سوال</button>
//       </div>
...
//         {questions.map((q, index) => (
//           <li className="AdminQuestion_li" key={index}>
//             <strong className="AdminQuestion_strong" >سوال {q.question_number}: {q.question_text}</strong>
//             {q.type === "test" && (
//               <ul className="AdminQuestion_strong_ul">
//                 {q.options.map((opt, idx) => (
//                   <li className="AdminQuestion_strong_li"  key={idx} style={{ color: idx === parseInt(q.correct_option) ? "green" : "black" }}>
//                     {opt}
//                   </li>
//                 ))}
//               </ul>
...
//       <div className="AdminQuestion_button_div_one">
//                  <button className="AdminQuestion_button_one" onClick={handleSendQuestions}>ارسال سوالات</button>
//       </div>
