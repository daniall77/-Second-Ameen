...
function AdminExam() {
  ...
  const handleCreateExam = async () => {
    ...
    const examData = {
      title: examTitle,
      type: examType,
      articles: selectedArticles.map((article) => article.value) , 
    };
...
//     console.log("اطلاعات ارسالی به بک:", examData);

//     try {
//       const response = await axios.post("http://localhost:8000/exams", examData, {
//         headers: {
//           Authorization: `Bearer ${cookies.access_token}`,
//         },
//       });
