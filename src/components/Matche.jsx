...
//               <h2 className="Matches_main_header_h">صفحه مسابقه</h2>
//             </header>

//             {examId ? (
//               <section className="Matches_exam_section">
//                 <div className="Matches_exam_info">
//                   <p className="Matches_exam_info_p">
//                     <strong className="Matches_exam_info_strong">کد مسابقه:</strong> {examId}
//                   </p>
//                 </div>
...
//                                 <strong className="Matches_question_strong">سوال {question.question_number}:</strong>{" "}
...
//                           {submitting ? <BeatLoader className="Matches_BeatLoader" /> : "پایان مسابقه"}
//                         </button>
//                       </footer>
//                     </section>
//                   ) : (
