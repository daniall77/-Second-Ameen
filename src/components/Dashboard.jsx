...
function Dashboard() {
  ...
  return (
    <div className="Dashboard_container" dir="rtl">
      ...
      <div className="Dashboard_mobile_menu" onClick={() => setIsSidebarOpen(true)}>
        <FiMenu className="Dashboard_FiMenu"  />
      </div>
      
 
      <div className={`Dashboard_sidebar ${isSidebarOpen ? "open" : ""}`}>
        <div className="Dashboard_sidebar_top">
          <div className="Dashboard_curved_section">
            ...
            <Link className="Dashboard_sidebar_link_img" to="Image">
              <img src={profileImage} alt="User Avatar" className="Dashboard_curved_img" />
            </Link>
          </div>
        </div>
        <div className="Dashboard_sidebar_bottom">
          <ul className="Dashboard_sidebar_menu">
            <li className={`Dashboard_sidebar_item ${location.pathname === "/Dashboard" ? "active" : ""}`}>
              <Link to="/Dashboard" className="Dashboard_sidebar_link">پنل کاربری</Link>
            </li>
            <li className={`Dashboard_sidebar_item ${location.pathname === "/Dashboard/Account" ? "active" : ""}`}>
              <Link to="Account" className="Dashboard_sidebar_link">اطلاعات حساب</Link>
            </li>
            <li className={`Dashboard_sidebar_item ${location.pathname === "/Dashboard/Content" ? "active" : ""}`}>
              <Link to="Content" className="Dashboard_sidebar_link">ایجاد مطلب</Link>
            </li>
            <li className={`Dashboard_sidebar_item ${location.pathname === "/Dashboard/ViewContent" ? "active" : ""}`}>
            ...
            {canAccessCorrecting() && (
              <li className={`Dashboard_sidebar_item ${location.pathname === "/Dashboard/ListExam" ? "active" : ""}`}>
                <Link to="ListExam" className="Dashboard_sidebar_link">تصحیح مسابقه</Link>
              </li>
            )}
          </ul>
          <div className="Dashboard_sidebar_logout">
            <button className="Dashboard_sidebar_link" onClick={handleLogout}>خروج</button>
          </div>
        </div>
      </div>
...
//                    <div>{renderProfileComponent()}</div>
