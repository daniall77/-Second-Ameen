...
//             ) : (
//               <div className="UserViewContent_articles">
//                 {pendingArticles.slice(0, visibleArticles).map((article) => (
//                   <div key={article.id} className="UserViewContent_article_card">
//                       <div className="UserViewContent_article_card_one">
//                           <img
...
//                   </div>
//                 ))}
//                 {visibleArticles < pendingArticles.length && (
//                     <button className="UserViewContent_show_more" onClick={showMoreArticles}>
//                             + بیشتر
//                      </button>
//                  )}
//               </div>
...
//             ) : (
//               <div className="UserViewContent_articles">
//                 {approvedArticles.slice(0, visibleArticles).map((article) => (
//                   <div key={article.id} className="UserViewContent_article_card">
//                       <div className="UserViewContent_article_card_one">
...
//                   </div>
//                 ))}
//                 {visibleArticles < approvedArticles.length && (
//                     <button className="UserViewContent_show_more" onClick={showMoreArticles}>
//                             + بیشتر
//                      </button>
//                  )}
...
//             ) : (
//               <div className="UserViewContent_articles">
//                 {rejectedArticles.slice(0, visibleArticles).map((article) => (
//                   <div key={article.id} className="UserViewContent_article_card">
...
//                 {visibleArticles < rejectedArticles.length && (
//                     <button className="UserViewContent_show_more" onClick={showMoreArticles}>
//                             + بیشتر
//                      </button>
//                  )}
